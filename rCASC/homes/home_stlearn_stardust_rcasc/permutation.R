...
p <- add_argument(p, "morphologicalFeaturesFile", help="PCA dimensions of morphological features of under spot tissue regions")
...
morphologicalFeaturesFile=argv$morphologicalFeaturesFile
...
morphologicalFeatures <- morphologicalFeatures[,-killedCell]
...
distMorph <- dist(tissuePosition,method="minkowski",p=2)
